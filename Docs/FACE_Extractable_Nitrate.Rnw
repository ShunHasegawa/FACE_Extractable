...
\caption{Soil-extractable nitrate at CO2 treatments}
\end{center}
\end{figure}
...
<<Stat_FACE_Extr_Nitrate_PreCO2Smmry, echo=TRUE, results='asis'>>=
@
...
<<Stat_FACE_Extr_Nitrate_PostCO2Smmry, echo=TRUE, results='asis'>>=
@
