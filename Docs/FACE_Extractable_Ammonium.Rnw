...
\caption{Soil-extractable ammonium at CO2 treatments}
\end{center}
\end{figure}
...
<<Stat_FACE_Extr_Ammonium_PreCO2Smmry, echo=TRUE, results='asis'>>=
@
...
<<Stat_FACE_Extr_Ammonium_PostCO2Smmry, echo=TRUE, results='asis'>>=
@
